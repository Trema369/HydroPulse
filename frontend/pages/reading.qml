    ...
    ColumnLayout {
        ...
        Item {
            ...
            Row {
                ...
                spacing: 0
                Text { text: "Hydro"; color: "#93c5fd"; font.pixelSize: 17; font.weight: Font.Black }
                Text { text: "Pulse"; color: "#fb923c"; font.pixelSize: 17; font.weight: Font.Black }
            }
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Repeater {
                            model: [
                                { label: "pH",          range: "6.5 – 8.5",   dot: "#facc15" },
                                { label: "Turbidity",   range: "< 4 NTU",     dot: "#ef4444" },
                                { label: "Temperature", range: "10 – 25 °C",  dot: "#22c55e" },
                                { label: "TDS",         range: "< 300 ppm",   dot: "#818cf8" },
                            ]
                        ...
                        Repeater {
                            model: [
                                { label: "Safe / Normal",       dot: "#22c55e" },
                                { label: "Caution / Moderate",  dot: "#facc15" },
                                { label: "Danger / Critical",   dot: "#ef4444" },
                            ]
                            delegate: Row {
                                required property var modelData
                                spacing: 8
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        Connections {
                            target: controller
                            function onPhChanged(ph)               { phGauge.value        = ph        }
                            function onTurbidityChanged(turbidity) { turbidityGauge.value = turbidity }
                            function onTempChanged(temp)           { tempGauge.value      = temp      }
                            function onTdsChanged(tds)             { tdsGauge.value       = tds       }
                        }
                    }
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            width: 160
                            radius: 10
                            color: calcMouse.containsMouse
                                   ? Qt.rgba(0.23, 0.51, 0.96, 0.22)
                                   : Qt.rgba(0.23, 0.51, 0.96, 0.14)
